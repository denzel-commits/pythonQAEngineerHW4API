...
class TestDogApi:
    ...
    def test_by_breed_rnd(self, breed, number, status, get_by_breed_rnd):
    ...
    def test_list_sub_breeds(self, status, breed, get_sub_breeds):
    ...
    def test_sub_breeds_rnd(self, breed, subbreed, number, status, get_sub_breeds_rnd):
