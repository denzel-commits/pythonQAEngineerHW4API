...
class TestPost:
    ...
    def test_create_post(self, create_post_request, get_post_by_id):
        ...
        """
        create_post_request.assert_status_code(201).validate(Post)
